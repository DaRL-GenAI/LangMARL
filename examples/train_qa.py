#!/usr/bin/env python3
"""Train 2-agent QA task using gpt-3.5-turbo (actor) + gpt-4o-mini (critic)."""
...
config = langmarl.LanguageTaskConfig(
    ...
    task_type="qa",
    benchmark_path=os.path.join(os.path.dirname(__file__), "..", "env", "lang_benchmark", "HotPotQA"),
    data_limit=100,
    num_agents=2,
    num_iterations=5,
    ...
    checkpoint_dir=os.path.join(os.path.dirname(__file__), "..", "experiments", "ckpt_qa"),
...
if __name__ == "__main__":
    print("=" * 60)
    print("LangMARL QA Task Training")
